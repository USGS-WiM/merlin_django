...
router.register(r'standardqualityassurancecodes', views.StandardQualityAssuranceCode, 'standardqualityassurancecodes')
router.register(r'standards', views.StandardViewSet, 'standards')
router.register(r'equipmentverifications', views.EquipmentVerificationViewSet, 'equipmentverifications')
...
router.register(r'bulkequipmentverifications', views.EquipmentVerificationBulkCreateUpdateViewSet, 'bulkequipmentverifications')
